...
return [
    'permissions' => [
        ...
        [
            'code' => 'documents.existing.imports.create',
            'name' => 'Tambah Arsip Dokumen Existing',
            'module' => 'Manajemen Dokumen',
            'route' => 'documents.existing.imports.create',
            'action' => 'create',
        ],
        [
            'code' => 'documents.existing.imports.store',
            'name' => 'Simpan Arsip Dokumen Existing',
            'module' => 'Manajemen Dokumen',
            'route' => 'documents.existing.imports.store',
            'action' => 'create',
        ],
        [
