...
return [
    'permissions' => [
        ...
        [
            'code' => 'documents.obsolete.imports.view',
            'name' => 'Lihat Arsip Dokumen Obsolete Legacy',
            'module' => 'Manajemen Dokumen',
            'route' => 'documents.obsolete.imports.index',
            'action' => 'view',
        ],
        [
            'code' => 'documents.obsolete.imports.create',
            'name' => 'Tambah Arsip Dokumen Obsolete Legacy',
            'module' => 'Manajemen Dokumen',
        ...
        [
            ...
            'name' => 'Simpan Arsip Dokumen Obsolete Legacy',
            'module' => 'Manajemen Dokumen',
            'route' => 'documents.obsolete.imports.store',
            'action' => 'create',
        ],
        [
            'code' => 'documents.obsolete.imports.detail',
            'name' => 'Lihat Detail Arsip Dokumen Obsolete Legacy',
            'module' => 'Manajemen Dokumen',
            'route' => 'documents.obsolete.imports.show',
            'action' => 'view',
        ],
        [
            'code' => 'documents.obsolete.imports.download',
            'name' => 'Download File Arsip Dokumen Obsolete Legacy',
            'module' => 'Manajemen Dokumen',
            'route' => 'documents.obsolete.imports.files.show',
            'action' => 'download',
        ],
        [
            'code' => 'documents.obsolete.imports.preview',
            'name' => 'Preview File Arsip Dokumen Obsolete Legacy',
            'module' => 'Manajemen Dokumen',
            'route' => 'documents.obsolete.imports.files.preview',
            'action' => 'preview',
        ],
        [
