...
<x-layouts::app :title="__($pageTitle)">
    <div class="space-y-8">
        <nav class="flex items-center gap-3 text-sm font-medium text-slate-500" aria-label="Breadcrumb">
            ...
            <flux:icon name="chevron-right" class="size-4 text-slate-400" />
            <a href="{{ $detailRoute }}" class="transition hover:text-sky-700" wire:navigate>{{ $document->nomor_dokumen ?: $document->nama_dokumen }}</a>
            <flux:icon name="chevron-right" class="size-4 text-slate-400" />
                        ...
                        @if ($currentFile)
                            ...
                            <div class="flex items-center justify-between rounded-xl border border-slate-200 bg-slate-50/70 p-4 transition" data-existing-file-card>
                                ...
                                <div class="flex items-center gap-2 shrink-0 ml-4">
                                    ...
                                    >
                                        <flux:icon name="eye" class="size-3.5 text-slate-500" />
                                        Lihat Dokumen
                                    </a>
                        ...
                        <div class="{{ $currentFile ? 'hidden' : '' }}" data-new-file-container>
                            ...
                            @if ($currentFile)
                                <div class="mt-3 flex justify-end">
                                    ...
                                    >
                                        <flux:icon name="arrow-uturn-left" class="size-3.5 text-slate-500" />
                                        Batal Ganti File
                                    </button>
                                </div>
                            @endif
